...
import com.example.movies.framework.database.AppDatabase
import com.example.movies.framework.database.dao.CategoryDAO
import com.example.movies.framework.database.dao.MovieDAO
import com.example.movies.framework.database.repository.CategoryDataSource
import com.example.movies.framework.database.repository.CategoryLocalRepository
import com.example.movies.framework.database.repository.MovieDataSource
...
import com.example.movies.framework.network.datasource.CategoryRemoteDataSourceImpl
import com.example.movies.framework.network.datasource.MovieRemoteDataSourceImpl
